Si tu souhaites tester ce projet en local ou y contribuer, voici la marche à suivre pour le cloner et l’installer sur ta machine :

1. Ouvre ton terminal
Commence par ouvrir un terminal ou un invite de commandes sur ton ordinateur.
...
Enfin, pour démarrer le serveur de développement, exécute la commande suivante :
