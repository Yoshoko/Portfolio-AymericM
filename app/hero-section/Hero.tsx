...
const Hero = () => {
  ...
  return (
    <motion.section
      className="relative z-10 flex h-[85vh] w-full items-stretch justify-center bg-[url('.//../public/hero.jpg')] bg-cover bg-center py-0 sm:h-[100vh] md:h-[100vh] 3xl:h-[100vh]"
      id="home"
      initial="initial"
      animate="animate"
    >
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
             Designer et développeur créatif. Actuellement en recherche d&apos;une alternance dès octobre 2025.
            <Link
              href=""
              target="_blank"
